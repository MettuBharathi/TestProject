			...
			try {
				...
				for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
					try {
						...
						TestEngineWeb.reporter.initTestCaseDescription("EUF09_FCTWebEndDisplayMyContactNotifications");
					...
					ReportStatus.fnUpdateResultStatus("FCTWebEndDisplayMyContactNotifications", "TC_EUF09", ReportStatus.strMethodName, intCounter, browser);
					fnCloseTest();
				}
			} catch (Exception e) {
				e.printStackTrace();
