			...
			try {
				...
				for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
					try {
						...
						TestEngineWeb.reporter.initTestCaseDescription("EUF11_FCTWebEndUserHeadintheClouds");
					...
					ReportStatus.fnUpdateResultStatus("FCTWebEndUserHeadintheClouds", "TC_EUF11", ReportStatus.strMethodName, intCounter, browser);
					fnCloseTest();
				}
			} catch (Exception e) {
				e.printStackTrace();
