...
public class REP03_AdHocReportDefaultSettingsTest extends CanadaLib{
	...
	public void TC_REP03(int StartRow, String EndRow, boolean nextTestJoin) throws Throwable {
		...
		try {
			...
			int intEndRow = ReportControl.fnGetEndRowCunt(EndRow, "TC_REP03AdHocReportDefaultSettings", TestData, "Reporting");
			for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
				try {
					...
					Hashtable<String, String> data = TestUtil.getDataByRowNo("TC_REP03AdHocReportDefaultSettings", TestData,
