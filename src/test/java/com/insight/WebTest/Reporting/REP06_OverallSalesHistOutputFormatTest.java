...
public class REP06_OverallSalesHistOutputFormatTest extends ReportingLib {
	...
	public void TC_REP06(int StartRow, String EndRow, boolean nextTestJoin) throws Throwable {
		...
		try {
			...
			int intEndRow = ReportControl.fnGetEndRowCunt(EndRow, "TC_REP06OverallSalesHistOutputFormat", TestData, "Reporting");
			for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
				try {
					...
					Hashtable<String, String> data = TestUtil.getDataByRowNo("TC_REP06OverallSalesHistOutputFormat", TestData,
